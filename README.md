...
---
## Chạy Dự án Bằng Docker Trên Localhost

Dự án đã được đóng gói hoàn chỉnh bằng **Docker** (gồm Backend, Frontend và Redis).  
Bạn không cần chạy thủ công Node hoặc Python. Mọi thành phần đều được khởi động tự động thông qua Docker Compose.
